...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    OP_EQUAL_EQUAL = 273,          /* OP_EQUAL_EQUAL  */
    OP_NOT_EQUAL = 274,            /* OP_NOT_EQUAL  */
    OP_LESS_THAN = 275,            /* OP_LESS_THAN  */
    OP_GREATER_THAN = 276,         /* OP_GREATER_THAN  */
    OP_LESS_EQUAL = 277,           /* OP_LESS_EQUAL  */
    OP_GREATER_EQUAL = 278,        /* OP_GREATER_EQUAL  */
    OP_PLUS = 279,                 /* OP_PLUS  */
    OP_MINUS = 280,                /* OP_MINUS  */
    OP_MULTIPLY = 281,             /* OP_MULTIPLY  */
    OP_DIVIDE = 282,               /* OP_DIVIDE  */
